...
//      }
      src = src.substring(match.length);
      out += this.renderer.wtlink(cap[1] || cap[4] || cap[5],
                           cap[3] || cap[1] || cap[4] || cap[5]);
//      this.tokens.push({
//        type: 'wtlink',
//        href: cap[1] || cap[4] || cap[5],
//        link: cap[3] || cap[1] || cap[4] || cap[5],
...
//      }
      src = src.substring(match.length);
      //src = src.substring(cap[0].length);
      out += this.renderer.wtat(cap[1], cap[2]);
//      this.tokens.push({
//        type: 'wtat',
//        href: cap[1],
//        link: cap[2],
...
//      }
      src = src.substring(match.length);
      out += this.renderer.wthash(cap[1], cap[2]);
      //src = src.substring(cap[0].length);
//      this.tokens.push({
//        type: 'wthash',
//        href: cap[1],
...
//      }
      src = src.substring(match.length);
      out += this.renderer.wtexclamation(cap[1], cap[2]);
      //src = src.substring(cap[0].length);
//      this.tokens.push({
//        type: 'wtexclamation',
//        key: cap[1],
...
//      }
      src = src.substring(match.length);
      out += this.renderer.wtemoji(cap[0]);
      //src = src.substring(cap[0].length);
//      this.tokens.push({
//        type: 'wtemoji',
//        text: cap[0],
...
//      }
      src = src.substring(match.length);
      out += this.renderer.wthexcolor(cap[0]);
      //src = src.substring(cap[0].length);
//      this.tokens.push({
//        type: 'wthexcolor',
//        color: cap[0],
...
Renderer.prototype.wthexcolor = function(color, prefix) {
  ...
  out += color + '<div class="" style="background:' + color + '"></div>';
  return out;
};
...
if (typeof module !== 'undefined' && typeof exports === 'object') {
  ...
  define(function() { return liteMarked; });
} else {
