...
(function() {
    ...
    var inline = {
        ...
        wtat: /^\[@(\w*)\|([^\]]+)\]/, // add by wh
        wthash: /^\[#(\w*)\|([^\]]+)\]/, // add by wh
        wtentity: /^\[#(task|event|file|approval|leave|mission|okr)(-)(\w*)\|([^\]]+)\]/, // add by macj
    ...
    InlineLexer.prototype.output = function(src) {
        var out = '',
            link, text, href, cap, origin, match;
    ...
    Renderer.prototype.image = function(href, title, text, origin) {
        if (this.options.isImageDefault) {
            ...
            if (this.options.isImgPreview) {
                out += '<a class="fancybox attachment-thumb ng-scope" href="' + href + '" data-fancybox-group="filegroup-detail-img" data-fancybox="images">';
